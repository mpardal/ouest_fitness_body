...
#[Route('/exhibitor', name: 'exhibitor_')]
//#[IsGranted('ROLE_EXHIBITOR')]
class ExhibitorController extends AbstractController
{
    ...
    public function index(): Response
    {
        ...
        $exhibitors = $userRepository->findByRole('ROLE_EXHIBITOR');
    ...
    public function preCreate(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('exhibitor_create', ['id' => $exhibitor->getId()]);
        }
